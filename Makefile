...
# Template: app
# Command: /usr/bin/qmake6 -o Makefile videoplayer.pro
#############################################################################
...
INCPATH       = -I. -Icrow/include -Iasio/asio/include -I/usr/include/librdkafka -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = videoplayer1.0.0
DISTDIR = /workspaces/VideoSage/.tmp/videoplayer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -lsqlite3 -lssl -lcrypto -lrdkafka++ -lrdkafka /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Network.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		videoplayer.pro ffmpeg.h \
		io.h \
		kafka/KafkaProducer.h ffmpeg.cpp \
		io.cpp \
		main.cpp \
		kafka/KafkaProducer.cpp
QMAKE_TARGET  = videoplayer
DESTDIR       = 
TARGET        = videoplayer
...
Makefile: videoplayer.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ffmpeg.h io.h kafka/KafkaProducer.h $(DISTDIR)/
	$(COPY_FILE) --parents ffmpeg.cpp io.cpp main.cpp kafka/KafkaProducer.cpp $(DISTDIR)/
...
main.o: main.cpp crow.h \
		...
		asio/asio/include/asio/detail/win_critsec_mutex.hpp \
		asio/asio/include/asio/detail/impl/win_critsec_mutex.ipp \
		...
		asio/asio/include/asio/execution/inline_exception_handling.hpp \
		...
		asio/asio/include/asio/detail/slim_mutex.hpp \
		asio/asio/include/asio/detail/atomic_slim_mutex.hpp \
		...
		asio/asio/include/asio/inline_executor.hpp \
		...
		asio/asio/include/asio/impl/awaitable.ipp \
		...
		asio/asio/include/asio/detail/resolver_thread_pool.hpp \
		asio/asio/include/asio/detail/impl/resolver_thread_pool.ipp \
...
KafkaProducer.o: kafka/KafkaProducer.cpp kafka/KafkaProducer.h \
		crow/include/crow/json.h \
		crow/include/crow/utility.h \
		crow/include/crow/settings.h \
		crow/include/crow/returnable.h \
		crow/include/crow/logging.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o KafkaProducer.o kafka/KafkaProducer.cpp
